...
class LexPOSBartModel(BartPretrainedModel):
    ...
    def forward(
        ...
        # pos_encoder_outputs[0][:,0,:]: (batch_size, embedding_dim) -> extract the hidden states of the <s> token
        ...
        decoder_outputs = self.decoder(
            ...
            encoder_hidden_states=encoder_outputs[0] + pos_encoder_outputs_repeated,  # Lexical + POS
